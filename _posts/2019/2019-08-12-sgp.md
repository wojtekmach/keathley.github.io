...
When that post initially came out, it changed the way that people thought about elixir apps. Modeling the domain with pure functions is a powerful approach and one that we should strive for when we can.
